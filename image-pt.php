...
?>
						...
						<div class="col-lg-12">
                            <div class="hero-nav-area">
                                <h1 class="text-white"><?php echo($res['title']); ?></h1>
						...
						<div class="col-lg-8 post-list">
							...
							<div class="single-post-wrap">
								<div class="feature-img-thumb relative">
									...
									<img class="img-fluid" src="admin/images/blog/<?php echo $res ["images"]; ?>" alt="">
								</div>
                        ...
                        while ($subrato = $result_de->fetch_assoc()) {
                        	...
                        	<div class="single-list flex-row d-flex">
									<div class="thumb">
										...
										<img style="width: 100px; height: 80px; " src="admin/images/blog/<?php echo $subrato ["images"]; ?>">
									</div>
									<div class="details">
